...
enum class UserSessionState
{
  ...
  AUTHENTICATION,    // authentication process is in progress (under the control of the auth method implementation )
                     // The "AUTHENTICATION" state can be skipped (switching directly from CREATED to READY),
